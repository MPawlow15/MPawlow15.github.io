$(document).ready(function() {
  const apiRoot = 'https://tasks-prod-kodilla-tasks-m213xr.mo5.mogenius.io/v1/tasks';
  const trelloApiRoot = 'https://tasks-prod-kodilla-tasks-m213xr.mo5.mogenius.io/v1/trello';
